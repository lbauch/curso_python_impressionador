...
def ler_xml_danfe(nota):
    ...
    with open(nota, 'rb') as arquivo:
        # transformar em OrderedDict - dicionário ordenado - seus valores são mantidos em ordem e possui pequenas diferenças em relação a um dict comum
    ...
    #  Ao fazer como abaixo, considera todos os itens como uma lista e cria somente uma linha
    resposta = {
    ...
    # Ao utilizar como abaixo - sem transformar em listas, para cada produto, será inserida uma linha
    # resposta = {
    #     'valor_total': valor_total,
    #     'cnpj_vendeu': cnpj_vendeu,
    #     'nome_vendeu': nome_vendeu,
...
nota_fiscal = '../arquivos_base/NFs Finais/DANFEBrota.xml'
resposta = ler_xml_danfe(nota_fiscal)

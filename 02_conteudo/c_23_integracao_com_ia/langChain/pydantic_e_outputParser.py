...
template_contexto = PromptTemplate.from_template("Você está avaliando reviews de um usuários sobre um produto, preciso de algumas informações extraídas desses reviews: {review}")
...
for review in reviews:
    prompt = template_final.invoke({"review": review})

...
# PARA INTEGRAR COM PSTGRESQL - pip install psycopg2; import psycopg2

from sqlalchemy import create_engine, Column, String, Integer, Boolean, ForeignKey
from sqlalchemy.orm import sessionmaker, declarative_base

# Estas 3 linhas de codigo são padrão, não é necessário alterá-las.
...
# Criar  as tabelas
class Usuario(Base):
    # Esta parte é opcional, para atribuir manualmente o nome da tabela
